document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateDisplay(selectedDate, data) {
        ...
        try {
            ...
            updateMultiLineChart(currentData, prevWeekData, selectedDate, prevWeekDate);
    ...
    function updateMultiLineChart(currentData, prevWeekData, selectedDate, prevWeekDate) {
        ...
        const maxValor = d3.max(processedCurrentData, d => Math.max(d.potenciaTotal, d.faseS, d.faseR, d.faseT));
        ...
        series.forEach(serie => {
            svg.selectAll(`.point-${serie.name.replace(/\s+/g, '-')}`)
                .on("mouseover", function(event, d) {
                    ...
                    const horaData = processedCurrentData.find(item => item.hora === d.hora);
